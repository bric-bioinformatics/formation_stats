...
The test gives a **p-value that is smaller than the threshold of 0.05**, it is significant. It means that we detect a statistical difference between variances. According to the **determination key**, we **cannot directly apply Student's t-test**, but we must apply a correction to this test, called **Welch's correction**.
